...
class Order extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->helper->isEnabled()) {
            $prefix     = $this->helper->getOrderPrefix();
            $suffix     = $this->helper->getOrderSuffix();
            $startFrom  = $this->helper->getOrderStartFrom();
            $step       = $this->helper->getOrderStep();
            $numLength  = $this->helper->getOrderNumberLength();
            ...
            $meta = $this->meta->loadByEntityTypeAndStore('order', $scope);
