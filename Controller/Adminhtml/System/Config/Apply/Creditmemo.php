...
class Creditmemo extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->helper->isEnabled()) {
            $prefix     = $this->helper->getCreditmemoPrefix();
            $suffix     = $this->helper->getCreditmemoSuffix();
            $startFrom  = $this->helper->getCreditmemoStartFrom();
            $step       = $this->helper->getCreditmemoStep();
            $numLength  = $this->helper->getCreditmemoNumberLength();
            ...
            $meta = $this->meta->loadByEntityTypeAndStore('creditmemo', $scope);
