...
class Invoice extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->helper->isEnabled()) {
            $prefix     = $this->helper->getInvoicePrefix();
            $suffix     = $this->helper->getInvoiceSuffix();
            $startFrom  = $this->helper->getInvoiceStartFrom();
            $step       = $this->helper->getInvoiceStep();
            $numLength  = $this->helper->getInvoiceNumberLength();
            ...
            $meta = $this->meta->loadByEntityTypeAndStore('invoice', $scope);
